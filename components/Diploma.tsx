...
export default function Diploma() {
	...
	return (
		<Box
			...
			sx={{
				background:
					theme?.palette?.mode === 'dark' ? '#010101' : '#fff',
				borderRadius: '18px',
			}}
						...
						>
							<div
								style={{
									...
									cursor: 'pointer',
									background:
										newWorkType == 'main' ? '#000' : '#fff',
									color:
										newWorkType == 'main' ? '#fff' : '#000',
								}}
							...
							<div
								style={{
									...
									marginLeft: '20px',
									background:
										newWorkType == 'test' ? '#000' : '#fff',
									color:
										newWorkType == 'test' ? '#fff' : '#000',
								}}
