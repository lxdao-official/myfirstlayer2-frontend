  ...
  return (
    <svg width={width} height={height} viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg" {...rest}>
      <path
        ...
        fill={color}
      />
      <path d="M9.5 10C9.5 8.71429 10.8125 7 13 7C15.1875 7 16.5 8.28571 16.5 10.4286C16.5 12.5714 13 13.8571 13 16" stroke={color} stroke-width="1.5" stroke-linecap="round" />
