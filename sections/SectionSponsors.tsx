...
export default function SectionSponsors() {
	...
	return (
		<SectionSimpleWrapper
			title={t(`sectionSponsors-title-10`)}
			desc={t('sectionSponsors-title-11')}
			id="next"
		>
			<Box>
				<Box
				...
				>
					...
					<Link
						target="_blank"
						href="https://twitter.com/brucexu_eth"
						underline="none"
					>
						<Box
							width="186px"
							...
							gap="10px"
						>
							<Typography fontWeight={600} color="#517def">
								Support us
							</Typography>
							<Box fontSize="12px" width="14px" height="12px">
								...
								>
									<path
										d="M1.16666 6H12M7.83332 1L12.2441 5.41074C12.5695 5.73618 12.5695 6.26382 12.2441 6.58926L7.83332 11"
										stroke="#517def"
										stroke-width="1.67"
