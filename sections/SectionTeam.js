...
const coreContributors = [
	{
		...
		description:
			'I wish to be an interesting piece of code in your metaverse.',
		name: 'brucexu.eth',
	...
	},
	{
		...
		description:
			'Front-end developer / PM at MyFirstLayer2 / Web3 buidler.',
		name: 'Logic',
...
export default function SectionTeam() {
	...
	return (
		<SectionSimpleWrapper
			title={t(`sectionTeam-content-11`)}
