		...
		<>
			...
			<Box
				sx={{
					...
					minHeight: { md: '830px' },
					background: {
						xs: 'no-repeat black right bottom/300px url(/bg-new.png)',
						md: 'no-repeat black right bottom/500px url(/bg-new.png)',
						lg: 'no-repeat black right bottom/40% url(/bg-new.png)',
					},
					py: '64px',
					mb: '40px',
				}}
