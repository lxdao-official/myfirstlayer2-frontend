        ...
        <Box className={classes.root} {...props}>
          <Box 
            ...
            <Box className={classes.content}>
              <Box sx={{ display: 'flex', width: '85px'}}>
                ...
                <Typography style={{fontSize: '12px', fontStyle: 'SemiBold', fontWeight: 200, paddingLeft: '5px'}}>{chapterData?.last ? '上一章' : '当前章节'}</Typography>
              </Box>
          ...
          >
            <Box className={classes.content}>
              ...
              <Typography style={{fontSize: '12px', fontStyle: 'SemiBold', fontWeight: 200, paddingRight: '5px'}}>{chapterData?.next ? '下一章' : '当前章节'}</Typography>
                <svg width="27" height="16" viewBox="0 0 27 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <Box {...props}>
            <Box 
              ...
              <Box className={classes.mobileContent}>
                <Box>
                  <Typography style={{fontSize: '8px', fontStyle: 'SemiBold', fontWeight: 200}}>{chapterData?.last ? '上一章' : '当前章节'}</Typography>
                  ...
                  chapterData?.last && ( */}
                    <Box fontSize={"8px"}>
                      <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M3.5 13C3.5 13.2761 3.72386 13.5 4 13.5C4.27614 13.5 4.5 13.2761 4.5 13L3.5 13ZM4.35355 0.646446C4.15829 0.451184 3.84171 0.451184 3.64645 0.646446L0.464466 3.82843C0.269204 4.02369 0.269204 4.34027 0.464466 4.53553C0.659729 4.7308 0.976311 4.7308 1.17157 4.53553L4 1.70711L6.82843 4.53553C7.02369 4.7308 7.34027 4.7308 7.53553 4.53553C7.7308 4.34027 7.7308 4.02369 7.53553 3.82843L4.35355 0.646446ZM4.5 13L4.5 1L3.5 1L3.5 13L4.5 13Z" fill="white"/>
                      </svg>
                    </Box>
                  {/* )
                } */}
              ...
              chapterData?.next && ( */}
                ...
                >
                  <Box className={classes.mobileContent}>
                    ...
                    <Box fontSize={"8px"}>
                      <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M3.5 1C3.5 0.723858 3.72386 0.5 4 0.5C4.27614 0.5 4.5 0.723858 4.5 1L3.5 1ZM4.35355 13.3536C4.15829 13.5488 3.84171 13.5488 3.64645 13.3536L0.464466 10.1716C0.269204 9.97631 0.269204 9.65973 0.464466 9.46447C0.659729 9.2692 0.976311 9.2692 1.17157 9.46447L4 12.2929L6.82843 9.46447C7.02369 9.2692 7.34027 9.2692 7.53553 9.46447C7.7308 9.65973 7.7308 9.97631 7.53553 10.1716L4.35355 13.3536ZM4.5 1L4.5 13L3.5 13L3.5 1L4.5 1Z" fill="white"/>
                      </svg>
                    </Box>
                  </Box>
                </Box>
