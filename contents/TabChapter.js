    ...
    <>
      <Hidden smDown>
        <Box className={classes.root} {...props}>
          <Card className={classes.container} style={{ marginRight: '15px' }} onClick={() => handleTabChapter('last')}>
          ...
          {/* {
              chapterData?.next && ( */}
          <Card className={classes.container} style={{ Left: '15px' }} onClick={() => handleTabChapter('next')}>
            <CardContent className={classes.content}>
              <Box>
